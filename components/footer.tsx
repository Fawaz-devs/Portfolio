      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-2xl font-bold gradient-text mb-4">Mohammed Fawaz Haneef</h3>
        ...
        >
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Mohammed Fawaz Haneef. All rights reserved.
          </p>
